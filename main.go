...
func (a *App) init() {
	...
	//add the handler for invoke uri
	caller := NewCaller()
	a.instrumentHandle("/invoke", "invoke", caller.invoke).Methods(http.MethodGet)
